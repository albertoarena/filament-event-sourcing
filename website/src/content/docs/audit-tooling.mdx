...
![The Stored Events browser](../../assets/screenshots/stored-event-browser.png)

A single stored event shows its pretty-printed payload:

![A stored event with its payload](../../assets/screenshots/stored-event-view.png)
...
![The event history slide-over](../../assets/screenshots/event-history.png)

The relation manager shows the same events as a tab on the record:

![The event history relation tab](../../assets/screenshots/event-history-relation-tab.png)
